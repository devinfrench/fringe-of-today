...
public class TutorialPane extends GraphicsPane {
	...
	public void keyPressed(KeyEvent e) {
		program.switchToMenu();	//Currently redirects to the main menu, will later go to the game
	}
}
